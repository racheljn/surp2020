    ...
    <Layout home>
      ...
      <div className={utilStyles.lightText} >
        <div>
          ...
          due to increasing globalization the image of mixed race Japanese has become somewhat more trendy in Japan<sub><sup>(<a href="https://surp2020.racheljn.vercel.app/sources">Yamashiro</a>)</sup></sub>. However becoming "trendy"
          doesnt equate to being accepted as Japanese and some Hafu in Japan struggle with their portrayal in the media and stereotypes surrounding Hafu, even going as far as suicide<sub><sup>(<a href="https://surp2020.racheljn.vercel.app/sources">McNeil</a>)</sup></sub>.
          </div>
          <br/>
          <div>
          ...
          However its difficult to fix the policy problems if many people believe that diversity doesnt exist in Japan or is so small that it doesn't matter.<sub><sup>(<a href="https://surp2020.racheljn.vercel.app/sources">下地(Shimoji)</a>)</sup></sub>
