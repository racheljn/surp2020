    ...
    <Layout home>
      ...
      <div className={utilStyles.lightText} >
        <div>
          ...
          Zainichi Koreans may be the third or fourth generation born and raised in Japan, and often only know Japanese<sub><sup>(<Link href="/sources"><a>Yamashiro</a></Link>)</sup></sub>. But they are still differentiated from mainstream Japanese, dont recieve Japanese citizenship, and experience discrimination in Japan based on their ethnic background, once it is discovered.
          Some change their names to try to pass as Japanese to avoid discrimination, or when applying to be a naturalized Japanese citizens face legal pressure to change their name to a Japanese one <sub><sup>(<Link href="/sources"><a>Murphy-Shigematsu</a></Link>)</sup></sub>.
          </div>
          <br/>
          <div id='Hafu'>
          Hafu are people who are half Japanese, they faced great stigma in the postwar period however
          due to increasing globalization the image of Hafu has become somewhat more trendy in Japan<sub><sup>(<Link href="/sources"><a>Yamashiro</a></Link>)</sup></sub>. However becoming "trendy"
          does not equate to being accepted as Japanese and some Hafu in Japan struggle with their portrayal in the media and stereotypes surrounding Hafu, even going as far as suicide<sub><sup>(<Link href="/sources"><a>McNeil</a></Link>)</sup></sub>.
          </div>
          <br/>
          <div>
          Additionally depending on the mix Hafu can face different levels of discrminiation for example, A ‘white-Japanese’ mix tends to be more highly regarded than, say, a ‘black-Japanese’ mix, due to colorism<sub><sup>(<Link href="/sources"><a>Yamashiro</a></Link>)</sup></sub>.
          Some Hafu are bullied in schools for looking different or having a darker skin color, and some end up dropping out or skipping school due to this <sub><sup>(<Link href="/sources"><a>下地(Shimoji)</a></Link>)</sup></sub>.
          ...
          mixed Asian Hafu might experience more constraints in claiming their ethnic background and having it validated by others<sub><sup>(<Link href="/sources"><a>Törngren</a></Link>)</sup></sub>.
          </div>
          <br/>
          <div>
          In 2018 the Japanese government signed a bill to allow for hundreds of thousands of workers to come to Japan to work in specific sectors such as construction, nursing and farming<sub><sup>(<Link href="/sources"><a>Okazaki</a></Link>)</sup></sub>.
          Additionally statistics found that in 2016 one in every 29 marriages was between a Japanese national and a foreign citizen <sub><sup>(<Link href="/sources"><a>International Marriages</a></Link>)</sup></sub>.
          ...
          However it's difficult to fix the policy problems if many people believe that diversity doesnt exist in Japan or is so small that it does not matter<sub><sup>(<Link href="/sources"><a>下地(Shimoji)</a></Link>)</sup></sub>.
